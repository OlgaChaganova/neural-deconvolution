...
def mse(image1: np.array, image2: np.array, **ssim_params) -> float:
    return mean_squared_error(image1, image2, **ssim_params)


def rmse(image1: np.array, image2: np.array, **ssim_params) -> float:
    return mean_squared_error(image1, image2, **ssim_params) ** 0.5
